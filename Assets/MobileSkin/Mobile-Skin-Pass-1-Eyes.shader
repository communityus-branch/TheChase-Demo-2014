Shader "Hidden/TheChase/Mobile-Skin-Pass-1-Eyes" {
Properties {
...
inline fixed4 LightingPseudoBRDF (MySurfaceOutput s, fixed3 lightDir, fixed3 viewDir, fixed atten)
{
	...
	fixed3 dots = saturate(fixed3(dot(s.Normal2, lightDir), dot(s.Normal2, viewDir), dot(-s.Normal2, lightDir)));
